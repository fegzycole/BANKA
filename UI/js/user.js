...
const cash_transactions_act = document.getElementById('cash-transactions'),
      dashboard_act         = document.getElementById('-dashboard'),
      view_users_act        = document.getElementById('view-users'),
      actions               = [dashboard_act,cash_transactions_act,view_users_act];
     ...
     show(0);
      ...
      const buttons = [dashboard,cash_transactions,view_users];
